...
│   └── config.sh
├── qcom-6.6.116-QLI.1.7-Ver.1.1
│   └── config.sh
├── qcom-6.6.116-QLI.1.7-Ver.1.1_qim-product-sdk-2.2.1
│   └── config.sh
├── qcom-6.6.116-QLI.1.7-Ver.1.1_realtime-linux-1.1
│   └── config.sh
├── qcom-6.6.116-QLI.1.7-Ver.1.1_robotics-sdk-1.1
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.0
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.0_qim-product-sdk-2.3.0
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.0_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.0_robotics-sdk-1.0
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.1
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.1_qim-product-sdk-2.3.1
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.1_realtime-linux-1.1
│   └── config.sh
├── qcom-6.6.119-QLI.1.8-Ver.1.1_robotics-sdk-1.1
│   └── config.sh
├── qcom-6.6.136-QLI.1.9-Ver.1.0
│   └── config.sh
├── qcom-6.6.136-QLI.1.9-Ver.1.0_qim-product-sdk-2.4.0
│   └── config.sh
├── qcom-6.6.136-QLI.1.9-Ver.1.0_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.136-QLI.1.9-Ver.1.0_robotics-sdk-1.0
│   └── config.sh
...
│   └── config.sh
├── qcom-6.6.136-QLI.1.9-Ver.1.1_robotics-sdk-1.1
│   └── config.sh
...
│   └── config.sh
├── qcom-6.6.90-QLI.1.5-Ver.1.1
│   └── config.sh
├── qcom-6.6.90-QLI.1.5-Ver.1.1_qim-product-sdk-2.0.1
│   └── config.sh
├── qcom-6.6.90-QLI.1.5-Ver.1.1_realtime-linux-1.1
│   └── config.sh
├── qcom-6.6.90-QLI.1.5-Ver.1.1_robotics-product-sdk-1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.0_qim-product-sdk-2.1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.0_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.0_robotics-sdk-1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.1_qim-product-sdk-2.1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.1_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.1_robotics-sdk-1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2_qim-product-sdk-2.1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2_robotics-sdk-1.2
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2.1_qim-product-sdk-2.1.1
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2.1_realtime-linux-1.0
│   └── config.sh
├── qcom-6.6.97-QLI.1.6-Ver.1.2.1_robotics-sdk-1.2
│   └── config.sh
├── README.md
└── utils
    ├── check_config.sh
...
Dockertag (qcom-6.6.136-qli.1.9-ver.1.0_22.04), Dockertag taken based on the release folder in small letters(Docker will not allow Capital letters in Docker tag and appending with Dockerfile OS version for easy to identify the release build with dockerfile.

```{.sh}
  $ bash docker/docker_build.sh -f ./docker/dockerfiles/Dockerfile_22.04 -t qcom-6.6.136-qli.1.9-ver.1.1_22.04
```
...
```{.sh}
  $ bash docker/docker_build.sh -n --no-cache -f ./docker/dockerfiles/Dockerfile_22.04 -t qcom-6.6.136-qli.1.9-ver.1.1_22.04
```
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.1_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.1
```
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.1_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.1 --build-override "base"
```

If you are facing issue with repo downloading from google, use below command for alternate repo

```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.1_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.1 --alternate-repo true
```
