...
```{.sh}
  $ bash docker/docker_build.sh -f ./docker/dockerfiles/Dockerfile_22.04 -t qcom-6.6.136-qli.1.9-ver.1.0_22.04
```
...
```{.sh}
  $ bash docker/docker_build.sh -n --no-cache -f ./docker/dockerfiles/Dockerfile_22.04 -t qcom-6.6.136-qli.1.9-ver.1.0_22.04
```
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.0_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.0
```
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.0_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.0 --build-override "base"
```

If you are facing issue with repo downloading from google, use below command for alternate repo

```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.136-qli.1.9-ver.1.0_22.04 -r qcom-6.6.136-QLI.1.9-Ver.1.0 --alternate-repo true
```
