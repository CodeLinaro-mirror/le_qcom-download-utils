...
Dockertag (qcom-6.6.38-qli.1.2-ver.1.1_22.04), Dockertag taken based on the release
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.38-qli.1.2-ver.1.1_22.04 -r qcom-6.6.38-QLI.1.2-Ver.1.1
```
...
```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.38-qli.1.2-ver.1.1_22.04 -r qcom-6.6.38-QLI.1.2-Ver.1.1 --build-override "base"
```

If you are facing issue with repo downloading from google, use below command for alternate repo

```{.sh}
  $ bash docker/docker_run.sh -t qcom-6.6.38-qli.1.2-ver.1.1_22.04 -r qcom-6.6.38-QLI.1.2-Ver.1.1 --alternate-repo true
```
